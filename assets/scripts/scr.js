...
function preguntas() {
  ...
  for (let ip = 1; ip < 8; ip++) {
    pag_s.innerHTML +=`<a class='px-2 py-4 text-center text-danger' style='font-size: 1.5rem;' href="?p=`+ip+`">`+ip+`</a>`;
    pag_b.innerHTML +=`<a class='px-2 py-4 text-center text-danger' style='font-size: 1.5rem;' href="?p=`+ip+`">`+ip+`</a>`;
  }
